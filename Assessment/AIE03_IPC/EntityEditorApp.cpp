...
EntityEditorApp::EntityEditorApp(int _screenWidth, int _screenHeight) :
	Application(_screenWidth, _screenHeight, "Entity Editor App")
{
...
void EntityEditorApp::Update(float _deltaTime)
{
	...
	for (int i = 0; i < ENTITY_COUNT; i++)
	{
		...
		m_entities[i].x -= s * _deltaTime;
		m_entities[i].y += c * _deltaTime;
